...
export function getColumnDefinations(datePipe: DatePipe): ColDef[] {
  return [
    ...
    { field: "billNo", headerTooltip: 'Bill No', minWidth: 150, flex: 2, tooltipField: 'billNo', autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
    {
      field: "date", headerTooltip: 'Date', headerName: 'Date', minWidth: 180, flex: 2, tooltipField: 'date', filter: 'agDateColumnFilter',
    ...
    { field: "patientName", headerTooltip: 'Patient Name', minWidth: 200, flex: 2, tooltipField: 'patientName', autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
