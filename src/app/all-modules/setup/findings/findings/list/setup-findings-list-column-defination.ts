...
export function getColumnDefinations(): ColDef[] {
    return [
        ...
        { field: "name",headerName : 'Findings', headerTooltip: 'Findings', filter: true, flex: 1, tooltipField: 'name', autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
        { field: "category", headerName : 'Findings Category', headerTooltip: 'Findings Category', filter: true, flex: 1, tooltipField: 'category' , autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
