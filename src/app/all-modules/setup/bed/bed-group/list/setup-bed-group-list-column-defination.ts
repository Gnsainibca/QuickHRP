...
export function getColumnDefinations(): ColDef[] {
    return [
        ...
        { field: "floor", headerTooltip: 'floor', filter: true, flex: 1, tooltipField: 'floor' , autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
