...
export function getColumnDefinations(): ColDef[] {
    return [
        ...
        { field: "radiologyUnit", headerName : 'Unit', headerTooltip: 'Unit', filter: true, flex: .7, tooltipField: 'radiologyUnit' , autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
