...
export function getColumnDefinations(): ColDef[] {
    return [
        ...
        { field: "name", headerName : 'Source', headerTooltip: 'Source', filter: true, flex: 1, tooltipField: 'name' , autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' } },
