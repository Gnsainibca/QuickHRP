...
import { MedicationFormComponent } from './form/medication-form.component';
import { MedicationGroupedList } from '../../shared/models/medication';
...
export class MedicationComponent {
  ...
  private openModal_Add(dateAddFor?: Date, timeAddFor?: string) {
    const modalRef = this.modalService.open(MedicationFormComponent, { windowClass: 'right', backdrop: 'static', scrollable: true });
