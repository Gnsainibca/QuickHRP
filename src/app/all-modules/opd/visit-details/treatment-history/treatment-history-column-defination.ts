...
export function getColumnDefinations(datePipe: DatePipe): ColDef[] {
    return [
        ...
        // { field: "patientVisitId", width: 120 },
        {
            field: "opdNo", headerTooltip: 'Opd No', width: 120, tooltipField: 'opdNo',
            cellRenderer: function (params: ICellRendererParams) {
                return `<a href="/opd/patient/visit-details/${params.data.opdPatientId}" >${params.data.opdNo}</a>`
            }
        },
        ...
        { field: "symptomsTypes", headerTooltip: 'Symptoms Types', width: 300, tooltipField: 'symptomsTypes', autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' },
            cellRenderer: function (params: ICellRendererParams) {
