...
export function getColumnDefinations(datePipe: DatePipe): ColDef[] {
  return [
    ...
    { field: "method", headerTooltip: 'Method', width: 200, tooltipField: 'method', autoHeight: true, wrapText: true, cellStyle: { 'line-height': '20px', 'padding-bottom': '10px', 'padding-top': '10px' }  },
