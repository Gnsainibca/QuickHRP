...
import { Operation } from 'src/app/all-modules/opd/shared/models/operation';
...
@Component({
  selector: 'app-ipd-operation-form',
  templateUrl: './ipd-operation-form.component.html',
  styleUrls: ['./ipd-operation-form.component.scss']
})
export class IPDOperationFormComponent {
