...
import { Vital } from 'src/app/all-modules/opd/shared/models/vital';
...
@Component({
  selector: 'app-ipd-vital-form',
  templateUrl: './ipd-vital-form.component.html',
  styleUrls: ['./ipd-vital-form.component.scss']
})
export class IPDVitalFormComponent {
  vitalForm!: FormGroup;
